...
public class CarDaoImpl implements Dao<String, Car> {

	// mappa con chiave il codice della risorsa
	TreeMap<String, Car> mappaRisorse;
	...
	public List<Car> getAllRecords() {
		...
		List<Car> listaResource = new ArrayList<>();
	...
	@Override
	public Car getRecord(String code) {
	...
	@Override
	public void deleteRecord(Car r) {
	...
	@Override
	public void updateRecord(Car r) {
